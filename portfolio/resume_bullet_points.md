# Resume Bullet Points (Based on Your E-Commerce Dataset)

Use these clean, direct bullet points on your resume or LinkedIn profile. They match your exact dataset with Aarav, Diya, Rohan, Meera, Kabir, Isha, Arjun, and Sanya.
...
## Select 3 to 4 Bullets for Your Resume

- **Cleaned and validated raw e-commerce order data in Excel** by identifying and removing negative quantities (ORD2041) and blank records (ORD2044), standardizing inconsistent text casing (`'north'` to `'North'`) using `TRIM` and `PROPER`, and setting up Data Validation rules.
